...
const VALIDATION_MESSAGES: Record<string, string> = {
  ...
  bar_required: 'The system bar must be a list.',
  bar_item_required: 'Every system bar item must be an object with a type.',
  bar_slot_invalid: 'A system bar item has an invalid start slot.',
  bar_span_invalid: 'A system bar item has an invalid width or extends beyond the bar.',
  bar_overlap: 'System bar items may not overlap.',
