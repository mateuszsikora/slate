...
If you were asked to set up a panel rather than to change Slate's code, this is not the document you want either: [`agent-setup.md`](agent-setup.md) is the runbook for taking a board from a cable to a published dashboard, and it touches nothing in the repository.
