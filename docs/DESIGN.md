...
Event channel for the editor and for remote diagnostics. The HTTP upgrade does not carry a
...
disconnect a diagnostics client that is otherwise still connected.
